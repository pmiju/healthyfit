...
public class exAdapter3 extends RecyclerView.Adapter<exAdapter3.ViewHolder> {
...
/*    public exAdapter(Activity context, ArrayList<exItem> list){
    ...
    @NonNull
    @Override
    public exAdapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull exAdapter3.ViewHolder holder, int position) {
        ...
        holder.exImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(view.getContext(), detail_list3.class);
