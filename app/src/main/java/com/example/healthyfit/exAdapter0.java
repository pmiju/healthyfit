...
public class exAdapter0 extends RecyclerView.Adapter<exAdapter0.ViewHolder> {
...
/*    public exAdapter(Activity context, ArrayList<exItem> list){
    ...
    @NonNull
    @Override
    public exAdapter0.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.liv0, parent, false);
        //ViewHolder viewHolder = new exViewHolder(view);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull exAdapter0.ViewHolder holder, int position) {
        ...
        holder.exImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(view.getContext(), detail_list0.class);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            exImg = itemView.findViewById(R.id.iv_title);
